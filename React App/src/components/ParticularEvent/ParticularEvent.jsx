...
import { getURL, getToken, getUsername } from "../../utils/index";
...
export default function ParticularEvent({
    match: {
      params: { id },
    },
  }) {
        ...
        () => {
            navigator.geolocation.getCurrentPosition((position) => {
                ...
                axios({
                    method: "GET",
                    url:
                      url + "/api/event/"+id+"/"+position.coords.latitude+"/"+position.coords.longitude,
                    headers: {
  ...
  <div className="fluid-container g-0 mw-100 feed-page">
    ...
    {showBigNavbar || window.innerWidth>1000 ?null:<RespNavbar />}
      ...
      {/* <div className="col post-cont"> */}
        ...
        { screenReady ? <Event id={id} data={event} /> : null}
    ...
    <div className="container container-fluid" style={{top: "3%", position: "sticky", margin: "5% auto"}}>
      <div className="container container-fluid light-bg" style={{margin: "5% auto"}}><img className="img-fluid" src="/images/5.svg" alt="ad banner" /></div>
    </div>
    </div> 
      </div>        
</div>
