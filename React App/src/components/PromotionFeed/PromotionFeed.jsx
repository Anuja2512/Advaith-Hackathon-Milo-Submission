...
import './PromotionFeed.css';

export default function PromotionFeed() {
        ...
        () => {
            navigator.geolocation.getCurrentPosition((position) => {
                ...
                axios({
                    method: "GET",
                    url:
                      url + "/api/promotionfeed/"+username+"/"+position.coords.latitude+"/"+position.coords.longitude,
                    headers: {
    ...
    return (
      ...
      {screenReady&&allowedLocation ?
        <div className="fluid-container g-0 mw-100 feed-page">
          ...
          <CreatePromotion style={{margin: "auto"}} />
          </div> 
            </div>        
    </div>
    : <Loading/>}
